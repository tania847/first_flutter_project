          ...
          DrawerHeader(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Image.network(
                    'https://seeklogo.com/images/F/food-chief-spoon-logo-778E6F7075-seeklogo.com.png',
                    width: 120,
                    height: 120,
                  ),
                  SizedBox(
...
class HomeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(0xff5C1834),
        title: Text(
          'Foodies',
